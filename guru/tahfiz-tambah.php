...
require_once "../template/sidebar.php";
 ...
 $carikode =mysqli_query($conn,"SELECT max(kode_tahfiz) from tbl_tahfiz ") or die(mysqli_error());
...
if ($msg == 'added') {
  ...
  <i class="fa-solid fa-circle-check"></i> Tambah Tahfiz berhasil..!!
        ...
        <div class="container-fluid px-4">
            <h1 class="mt-4">Tambah Nilai</h1>
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active">Tambah Tahfiz</li>
                </ol>
                <form action="tahfiz-proses.php" method="POST" enctype="multipart/form-data">
                	<?php 
                		if ($msg !== '') {
                			echo $alert;
                		}
                ...
                <div class="card">
					<div class="card-header">
					    <span class="h5 my-3"><i class="fa-solid fa-square-plus"></i> Tambah Tahfiz</span>
					...
					<div class="card-body">
					   <div class="row">
					   	<div class="col-8">
					   		<div class="mb-3 row">
							    <label for="kode_tahfiz" class="col-sm-2 col-form-label">Kode Tahfiz</label>
							    <label for="kode_tahfiz" class="col-sm-1 col-form-label">:</label>
							    <div class="col-sm-9" style="margin-left: -50px;">
							      <input type="text" name="kode_tahfiz" readonly class="form-control-plaintext border-bottom ps-2" id="kode_tahfiz" value="<?= $kode_otomatis ?>">
							    </div>
					    	</div>
					    	<div class="mb-3 row">
							...
							<div class="mb-3 row">
								...
								<label for="" class="col-sm-1 col-form-label">:</label>
								<div class="col-sm-9" style="margin-left: -50px;">
								    <input type="text" class="form-control border-0 border-bottom" id="surah1" name="surah1" required>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<label for="" class="col-sm-1 col-form-label">:</label>
								<div class="col-sm-9" style="margin-left: -50px;">
								    <input type="text" class="form-control border-0 border-bottom" id="ayat1" name="ayat1" required>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<label for="" class="col-sm-1 col-form-label">:</label>
								<div class="col-sm-9" style="margin-left: -50px;">
								    <input type="text" class="form-control border-0 border-bottom" id="surah2" name="surah2" required>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<label for="" class="col-sm-1 col-form-label">:</label>
								<div class="col-sm-9" style="margin-left: -50px;">
								    <input type="text" class="form-control border-0 border-bottom" id="ayat2" name="ayat2" required>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<label for="" class="col-sm-1 col-form-label">:</label>
								<div class="col-sm-9" style="margin-left: -50px;">
								    <input type="text" class="form-control border-0 border-bottom" id="surah3" name="surah3" required>
								</div>
							</div>
							<div class="mb-3 row">
								...
								<label for="" class="col-sm-1 col-form-label">:</label>
								<div class="col-sm-9" style="margin-left: -50px;">
								    <input type="text" class="form-control border-0 border-bottom" id="ayat3" name="ayat3" required>
								</div>
							</div>
							<div class="mb-3 row">
