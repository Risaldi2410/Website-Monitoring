...
$title = "Profile Sekolah - PESANTREN MAQ";
...
if ($msg == 'update') {
  ...
  <i class="fa-solid fa-circle-check"></i> Data sekolah berhasil di perbaharui !
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
				  ...
				  <div class="card-body">
				   <div class="row">
				   	<div class="col-4 text-center px-5">
				   		...
				   		<img src="../assets/images/<?= $data['gambar']?>" alt="gambar sekolah" class="mb-3" width="100%">
				   		<input type="file" name="image" class="form-control form-control-sm">
				   		<small class="text-secondary">Pilih Gambar PNG, JPG, atau JPEG dengan maksimal 1 MB</small>
				   	</div>
				   	<div class="col-8">
