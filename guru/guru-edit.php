...
$title = " Update Guru - MTS KSM KALUPAPI";
...
$queryGuru = mysqli_query($conn, "SELECT * FROM tbl_guru WHERE nip ='$nip'");
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4"> Update Guru</h1>
                ...
                <form action="guru-edit-act.php" method="POST" enctype="multipart/form-data">
                <div class="card">
			    	...
			    	<div class="card-body">
			    		<div class="row">
			    			...
			    			<div class="col-4 text-center px-5">
			    				...
			    				<img src="../assets/images/<?= $data['foto'] ?>" class="mb-3" width="40%" alt="">
