...
$title = "Update Siswa - MTS KSM KALUPAPI";
...
$siswa = mysqli_query($conn, "SELECT * FROM tbl_siswa WHERE nis ='$nis'");
    ...
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4"> Update Siswa</h1>
                ...
                <form action="siswa-edit-act.php" method="POST" enctype="multipart/form-data">
                <div class="card">
				  ...
				  <div class="card-body">
				  	<div class="row">
				  		...
				  		<div class="col-4 text-center px-5">
				  			...
				  			<img src="../assets/images/<?= $data['foto'] ?>" alt="" class="mb-3 rounded-circle" width="40%">
